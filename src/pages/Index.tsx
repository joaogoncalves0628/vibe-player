...
const Index = () => {
  ...
  return (
    ...
    >
      {/* Hero */}
      <section className="relative overflow-hidden px-4 sm:px-6 pt-8 sm:pt-12 pb-6 sm:pb-8 max-w-screen-xl mx-auto">
        <motion.div
        ...
        >
          <div className="flex items-center gap-3 mb-3 sm:mb-4">
            ...
            >
              <Disc3 className="w-7 h-7 sm:w-8 sm:h-8 text-primary" />
            </motion.div>
            <div className="flex items-center gap-2">
              <Sparkles className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-accent" />
              <span className="text-xs sm:text-sm text-muted-foreground font-medium">Sua coleção de música</span>
            </div>
          </div>
          <h1 className="text-3xl sm:text-5xl font-display font-bold text-foreground mb-1 sm:mb-2">
        ...
        {/* Background glow */}
        <div
          className="absolute top-0 right-0 w-64 sm:w-96 h-64 sm:h-96 rounded-full blur-3xl opacity-20 animate-pulse-glow pointer-events-none"
      ...
      <section className="px-4 sm:px-6 max-w-screen-xl mx-auto">
        <motion.h2
          ...
          className="text-lg sm:text-xl font-display font-semibold mb-4 sm:mb-6 text-foreground"
        >
          Álbuns
        </motion.h2>
        ...
        {albums[0].songs.length === 0 && albums.length === 1 ? (
          ...
          >
            ...
            >
              <Disc3 className="w-12 sm:w-16 h-12 sm:h-16 text-primary mx-auto mb-4 opacity-60" />
            </motion.div>
